...
async function getDatabaseCustomersForActiveOrganization(query: string) {
  if (!getDatabase()) return { customers: [], databaseAvailable: false };
...
export default async function CustomersPage({
  ...
  const result = await getDatabaseCustomersForActiveOrganization(query);
