...
export default function CustomerOrgLoginPage({
  ...
  return (
    <Suspense fallback={<div className="mx-auto flex min-h-screen max-w-md items-center p-4 text-sm text-muted-foreground">Loading customer login…</div>}>
      <CustomerOrgLoginContent params={params} />
    </Suspense>
  );
}
